...
dependencies {
    ...
    api("ch.admin.bar:siard-api:v2.2.137")
    api("ch.admin.bar:SqlParser:v2.2.5")
    api("ch.admin.bar:Zip64File:v2.2.6")
    api("ch.admin.bar:enterutilities:v2.2.6")
    api("ch.admin.bar:jdbc-base:v2.2.12")
    api("ch.admin.bar:JdbcPostgres:v2.2.5")
    api("ch.admin.bar:jdbcoracle:v2.2.9")
    api("ch.admin.bar:jdbcmssql:v2.2.6")
    api("ch.admin.bar:jdbc-mysql:v2.2.6")
    api("ch.admin.bar:jdbc-access:v2.2.5")
    api("ch.admin.bar:jdbc-db2:v2.2.5")
