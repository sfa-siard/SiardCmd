...
public class OracleFromDbTester extends BaseFromDbTester
{
  ...
  @Test
  public void testOracleFromDb()
  {
    System.out.println("testOracleFromDb");
    try
    {
      ...
      TestOracleDatabase.grantSchema(connOracle, ch.admin.bar.siard2.oracle.TestSqlDatabase._sTEST_SCHEMA, _sORACLE_DB_USER);
      System.out.println("Create TestOracleDatabase");
      new TestOracleDatabase(connOracle);
      TestOracleDatabase.grantSchema(connOracle, TestOracleDatabase._sTEST_SCHEMA, _sORACLE_DB_USER);
      connOracle.close();
