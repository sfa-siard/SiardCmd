package ch.admin.bar.siard2.cmd.mssql.usecases.keys.download;
...
public class MsSqlDownloadSiardProjectIT {
     ...
     * +-------------------+          +-------------------+          +---------------------+
     */
    public final static String CREATE_SIMPLE_TEAMS_EXAMPLE = "mssql/usecases/keys/download/create-simple-teams-example_mssql.sql";
